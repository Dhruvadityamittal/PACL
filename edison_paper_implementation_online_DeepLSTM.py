...
if __name__ == '__main__':
    for fold in folds:
        ...
        pth_pth = '{}{}_{}_best_windowlen_{}_embedding_size_{}_version_{}_step_{}_fold_{}_session_split_{}.pth'.format(pth_rst_exp_step_1, args.dataset, args.model, window_len, args.sz_embedding, version, step, fold)
        ...
        stage_2_acc_0, stage_2_f1_0, stage_2_acc_1, stage_2_f1_1, _, _ = get_accuracy_old_new_LSTM(model, dlod_test, nb_classes, nb_classes_now, trained_prototypes_dict)
