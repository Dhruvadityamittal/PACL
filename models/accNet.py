...
class Resnet_new(nn.Module):
    ...
    def __init__(self, cfg, is_mtl=False):
        ...
        resnet_version = 1
        self.name = 'resnet18'
        self.kd_weight_lr = nn.Parameter(torch.tensor([1.0]))
        self.contrastive_weight_lr = nn.Parameter(torch.tensor([1.0]))
        self.pa_weight_lr  = nn.Parameter(torch.tensor([1.0]))
