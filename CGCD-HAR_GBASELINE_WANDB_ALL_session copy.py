...
if __name__ == '__main__':
    ...
    for lr, kd_weight, pa_weight,contrastive_weight, fold in itertools.product(lrs, kd_weights, pa_wights,contrastive_weights, folds):
        ...
        inputs = torch.randn(5, 3, 100).to(device)
        ...
        with profile(activities=activities, schedule=torch.profiler.schedule(wait=1, warmup=1, active=2), on_trace_ready=trace_handler) as p:
