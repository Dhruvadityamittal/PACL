...
if __name__ == '__main__':
    ...
    for epoch in range(0,args.nb_epochs):  #args.nb_epochs
        ...
        if(best_acc<val_accuracy):
            ...
            np.save('{}{}_{}_prototypes_windowlen_{}_embedding_size_{}_version_{}_step_{}_fold_{}.npy'.format(pth_rst_exp, args.dataset, args.model, window_len, args.sz_embedding, version, step), tuple_list)
            torch.save({'model_pa_state_dict': model.state_dict()}, '{}{}_{}_best_windowlen_{}_embedding_size_{}_version_{}_step_{}_fold_{}.pth'.format(pth_rst_exp, args.dataset, args.model, window_len, args.sz_embedding, version, step))
